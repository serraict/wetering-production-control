...
from production_control.potting_lots.url_parser import extract_lot_id_from_barcode, is_potting_lot_url


class TestExtractLotIdFromBarcode:
    """Test cases for extracting lot ID from barcode text."""

    @pytest.mark.parametrize("input_text,expected_id,description", [
        ...
        ("https://example.com/potting-lots/scan/123/extra/path", 123, "URL with extra path segments"),
        ("  https://example.com/potting-lots/scan/456  ", 456, "URL with surrounding whitespace"),
        ("https://example.com/potting-lots/scan/789?param=value", 789, "URL with query parameters"),
